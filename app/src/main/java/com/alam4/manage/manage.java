...
public class manage extends AppCompatActivity {
    ...
    private void download() {
        Background background = new Background(manage.this, recyclerView);
        background.execute();
            ...
            private Boolean ParseJsonDt() {
                ...
                try {
                    ...
                    while (i < jsonArray.length()) {
                        ...
                        sp.setNumberofalerts(jsonObject.getString("numberofalerts"));
                        arrayList.add(sp);
    ...
    private void checkGroup(String name) {
        Intent  intent=new Intent(manage.this, managealerts.class);
