package com.alam4.notification;
...
public class allnotifications extends AppCompatActivity {
    ...
    private void download() {
        Background background = new Background(allnotifications.this, recyclerView);
        background.execute();
    ...
    private class Background extends AsyncTask<String, String, String> {
        ...
        protected class GetConnected {
            ...
            String sign_url = new connection(context).getnotify();
    ...
    private class AdapterClass extends RecyclerView.Adapter <MyHoder>{
        List<notes> servicemodels;
        Context context;
        RecyclerView recyclerView;

        public AdapterClass(List<notes> servicemodels, Context context, RecyclerView recyclerView) {
        ...
        public MyHoder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            return new MyHoder(LayoutInflater.from(this.context).inflate(R.layout.note, viewGroup, false));
        }

        @Override
        public void onBindViewHolder(@NonNull MyHoder myHoder, int i) {
            final notes sm = servicemodels.get(i);
            String name;
            name=sm.getName();
    ...
    public void onBackPressed() {
        startActivity(new Intent(allnotifications.this, dashboard.class));
        Animatoo.animateSlideRight(context);
        allnotifications.this.finish();
        super.onBackPressed();
    }
}
