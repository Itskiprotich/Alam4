...
public class eachresponsegroup extends AppCompatActivity {
    ActionBar actionBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eachresponsegroup);
    ...
    private void download() {
        Background background = new Background(eachresponsegroup.this, recyclerView);
        background.execute();
    ...
    private class Background extends AsyncTask<String, String, String> {
        ...
        protected class GetConnected {
            ...
            String sign_url = new connection(context).eachgroupalert();
            ...
            private Boolean ParseJsonDt() {
                ...
                try {
                    ...
                    while (i < jsonArray.length()) {
                        ...
                        String lo = jsonObject.getString("groupname");
            ...
            if (status.equalsIgnoreCase("Neutralized")) {
                ...
                myHoder.cardView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        activeAlert(groupname,poster,name,notes,code,level);
                    }
                });
            }
        }
    ...
    private void activeAlert(String groupname, String poster, String name, String notes, String code, String level) {
    ...
    private class MyHoder extends RecyclerView.ViewHolder {
        TextView Code, Nature, Notes, Location, Level;
        ImageView Attach;
        CardView cardView;
