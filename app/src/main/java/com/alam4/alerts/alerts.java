...
import com.alam4.each.eachresponsegroup;
...
public class alerts extends AppCompatActivity {
    ...
    private void download() {
        Background background = new Background(alerts.this, recyclerView);
        background.execute();
    ...
    private void checkGroup(String name) {
        Intent intent = new Intent(alerts.this, eachresponsegroup.class);
    ...
    public void onBackPressed() {
        startActivity(new Intent(alerts.this, dashboard.class));
